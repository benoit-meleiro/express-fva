...
// const inscriptions = require('./mock-club');
...
//               prenomResponsableOuverture: session.prenomResponsableOuverture,
...
//       })
//  //* on ajoute les joueurs présents aux sessions
//  .then(()=> { 
...
//       }).then(inscription => console.log(inscription.toJSON()))
